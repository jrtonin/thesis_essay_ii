...
# defining equations
OLS = price ~  hubling + aircraft + flight_hours + paid_luggage + free_luggage + 
  connection + X6.11 + X12.17 + X18.23 + RouteShare + factor(Tourist) + factor(N) + factor(market) + 
  factor(covid) + factor(covid_wave) + factor(quarter) + factor(ArrHUB) + factor(market_arr) +
  factor(capital_arr)

IV = price ~ hubling + aircraft + flight_hours + paid_luggage + free_luggage + 
  connection + X6.11 + X12.17 + X18.23 + RouteShare + factor(Tourist) + factor(N) + factor(market) + 
  factor(covid) + factor(covid_wave) + factor(quarter) + factor(ArrHUB) + factor(market_arr) +
  factor(capital_arr) | . -RouteShare + m150RouteShare

GMM = price ~ lag(price) + hubling + aircraft + flight_hours + paid_luggage + free_luggage + 
  connection + X6.11 + X12.17 + X18.23 + RouteShare | lag(RouteShare, 1:10) + lag(price, 2:10) + m150RouteShare 
